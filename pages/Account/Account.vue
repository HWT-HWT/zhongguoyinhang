	...
	<view class="account">
		...
		<view class="account-Datali">
			<view class="Datali-Text">
				...
				<view class="money p" @click="GoAssets">{{!Eye ? '******': '3.06'}} <image src="../../static/upsdk_payment_right.webp" mode=""></image> </view>
		...
		<view class="account-card">
			...
			<CardBox :id="1" :list-btn="['交易明细','转账','买理财']" card-name="0613 ****** 0716" sub-name="长城电子借记卡(II类账户)" money='3.06' @Next="Next" :Eye='Eye'></CardBox>
